...
h_fourth_row=fig_h-4*row_height;
h_fifth_row=fig_h-5*row_height;
...
this.Gui.Window = figure('Name', 'PeakFinder',...
    ...
    'Units','Pixels',...
    'Position',[400,0,fig_width,fig_h],...
...
this.Gui.FitWidthLabel=uicontrol(this.Gui.Window,...
    'Style','edit',...
    'Units','pixels',...
    'Position',[x_first_col,h_fourth_row+10,edit_size],...
    'String','Fit width',...
    'Enable','off');
%Button for changing the resonance separation
this.Gui.FitWidthEdit=uicontrol(this.Gui.Window,...
    'Style','edit',...
    'Units','Pixels',...
    'Position',[x_first_col,h_fifth_row+30,edit_size],...
    'String','16');
