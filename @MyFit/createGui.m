...
this.Gui.BaseDir=uicontrol('Parent',this.Gui.FileNameBox,...
    'style','edit','String',this.SaveInfo.base_dir,'HorizontalAlignment','Left',...
    'FontSize',10);
this.Gui.SessionName=uicontrol('Parent',this.Gui.FileNameBox,...
    'style','edit','String',this.SaveInfo.session_name,'HorizontalAlignment','Left',...
    'FontSize',10);
this.Gui.FileName=uicontrol('Parent',this.Gui.FileNameBox,...
    'style','edit','String',this.SaveInfo.filename,'HorizontalAlignment','Left',...
    'FontSize',10);
...
for i=1:this.n_params
    ...
    this.Gui.(edit_str)=uicontrol('Parent',this.Gui.(vbox_str),...
        ...
        'FontSize',14,'Tag',num2str(i),'HorizontalAlignment','Right',...
    ...
    this.Gui.([lim_str,'_lower'])=uicontrol('Parent',this.Gui.(lim_str),...
        ...
        'FontSize',10,'Tag',sprintf('Lower%i',i),'HorizontalAlignment','Right',...
        'Position',[1,1,edit_width-4,30],'Units','Pixels','Callback',...
        @(hObject,eventdata) limEditCallback(this, hObject, eventdata));
    this.Gui.([lim_str,'_upper'])=uicontrol('Parent',this.Gui.(lim_str),...
        'Style','edit','String',sprintf('%3.3e',this.lim_upper(i)),...
        'FontSize',10,'Tag',sprintf('Upper%i',i),'HorizontalAlignment','Right',...
        'Position',[1,1,edit_width-4,30],'Units','Pixels','Callback',...
        @(hObject,eventdata) limEditCallback(this, hObject, eventdata));
