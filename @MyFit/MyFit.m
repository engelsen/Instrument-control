        ...
        function createFitStruct(this)
            ...
            addFit(this,'DoubleLorentzianGrad',...
             ...
             addFit(this,'Gorodetsky2000',...
                ['c*x+a*abs( (k0^2/4 - kex^2/4 + gamma^2/4 - (x-b).^2 + i*k0.*(x-b))',...
                './( (k0 + kex)^2/4 + gamma^2/4 - (x-b).^2 + i.*(x-b)*(k0 + kex) )).^2'],...
                ['$$c+dx+a\left|\frac{\kappa_0^2/4-\kappa_{ex}^2/4+\gamma^2/4-(x-b)^2+i\kappa_0(x-b)/2}',...
                '{(\kappa_0+\kappa_{ex})^2/4+\gamma^2/4-(x-b)^2+i(x-b)(\kappa_0+\kappa_{ex})}\right|^2$$'],...
                { 'a','b','c','gamma','k0', 'kex'},...
                {'Background','BG Slope','Center','Mode splitting',...
                'Intrinsic','Extrinsic'});
