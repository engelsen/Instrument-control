...
function createUserControls(this, varargin)
    ...
    this.Gui.UserInnerHbox = uix.HBox( ...
        'Parent',           this.Gui.UserPanel, ...
        'BackgroundColor',  bg_color);
    this.Gui.UserParamNameVbox = uix.VBox( ...
        'Parent',           this.Gui.UserInnerHbox, ...
        'BackgroundColor',  bg_color);
    this.Gui.UserParamEditVbox = uix.VBox( ...
        'Parent',           this.Gui.UserInnerHbox, ...
        'BackgroundColor',  bg_color);
    set(this.Gui.UserInnerHbox, 'Widths', [-2,-1]);
