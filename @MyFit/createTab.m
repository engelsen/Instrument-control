...
for i=1:length(names)
    createUnitDisp(this,'BackgroundColor',bg_color,...
        'Tag',names{i},...
        'Parent',tab_tag,'Title',this.UserGuiStruct.(tab_tag).(names{i}).title,...
        'Enable',this.UserGuiStruct.(tab_tag).(names{i}).change_flag,...
