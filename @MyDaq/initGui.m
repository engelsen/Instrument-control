...
this.Gui.SaveData.Callback=@(hObject, eventdata) ...
    saveCallback(this, hObject,eventdata);
...
%Sets callback for open directory button
this.Gui.OpenFolderButton.Callback=@(hObject,eventdata)...
    openFolderCallback(this,hObject,eventdata);
